...
In \gls{la} this article, I shall discuss some of the fundamental topics in
...
well structured document within \LaTeX\cite{chiu}.  You should quickly be able to
...
For example, a book has chapters but a article doesn't. Odnosnik do tabeli \ref{tab:sampletab}
...
\begin{center}
	...
	\end{tabular}
\end{center}
  \caption*{zrodlo tabeli}
\end{table}

\unsure[inline]{Fix me}
...
\begin{figure}[h]
\begin{center}
    \includegraphics[width=0.5\textwidth]{foto.png}
\end{center}
  \caption[short - gull]{A picture of a gull. bardzo dlugi opis rysnklu jeszcze dluzej aaaaaaaaaaaaaaaaaa rysunkek bla bla bla bla blaadasd sadnasujvndsjiogf jdifjsdiof dsjfiods jfido \thefigure}
  \caption*{zrodlo rysunku \ref{ap:ap1}}
  \label{img:gull}
\end{figure}
...
\begin{center}
    \includegraphics[width=0.5\textwidth]{foto.png}
\end{center}
  \caption[short - gull2]{A picture of a gull. bardzo dlugi opis rysnklu jeszcze dluzej aaaaaaaaaaaaaaaaaa rysunkek bla bla bla bla bla asdkaosdkaosdkao dsakods akdosa dkaos dkaso \thefigure}
  \caption*{zrodlo rysunku \ref{ap:ap1}}
  \label{img:gull2}
\end{figure}
